        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Deducciones</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="form_basic.html">Lista de deducciones</a></li>
                            <li><a href="form_advanced.html">Alta deducción</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Puestos</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <li><a href="form_basic.html">Lista de puestos</a></li>
                            <li><a href="form_advanced.html">Alta puesto</a></li>
                        </ul>
                    </li>
                    <li>
